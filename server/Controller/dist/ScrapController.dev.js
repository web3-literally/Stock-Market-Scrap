...
function () {
  ...
  _createClass(ScrapController, [{
    ...
    value: function GetAnalysis(data) {
      var company_detail, series_ids, c_date, day, temp_date, month, series, rsp, psp, rsi, tp, sl, bollinger_band, drawdown, current_price, current_high, current_low, max_price, min_price, layer, price_movement;
    ...
    value: function GetAnalysisByDate(company_id) {
      var days, result, analysis_result, series, _i, _days, day, temp, updated_at;
